...
export const MultiTabStatusBar: React.FC<MultiTabStatusBarProps> = ({
    ...
    return (
      <div className="flex max-w-[240px] items-center justify-between rounded-md border border-stone-200 bg-white px-3 py-2 text-sm">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            className="flex items-center rounded-md border border-stone-300 bg-white px-2 py-1 text-xs text-stone-700 transition-colors duration-150 hover:border-stone-500 hover:text-stone-900"
  ...
  return (
    <div className="flex max-w-[280px] items-center justify-between rounded-md border border-stone-200 bg-white px-3 py-2 text-sm">
      ...
      <div className="flex items-center ml-3 space-x-1">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
          className="rounded-md border border-stone-300 bg-white px-2 py-1 text-xs text-stone-600 transition-colors duration-150 hover:border-stone-500 hover:text-stone-900"
            onClick={() => setIsDropdownOpen(!isDropdownOpen)}
            title="Switch tab"
          >
